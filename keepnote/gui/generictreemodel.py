...
class GenericTreeModel(GObject.GObject, Gtk.TreeModel):
    ...
    def __init__(self):
        ...
        self.logger.debug("keepnote.gui.generictreemodel.GenericTreeModel.__init__()")
    ...
    def invalidate_iters(self):
        ...
        """
        self.logger.debug("keepnote.gui.generictreemodel.GenericTreeModel.invalidate_iters()")
